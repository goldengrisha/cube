...
LOGGER = logging.getLogger("test.huggingface_stable_diffusion.server")
...
def _warmup():
    """
    Warm up the model with a dummy prompt to optimize for the first request.
    """
    dummy_prompt = "A simple warmup prompt"
    pipe(dummy_prompt)  # Perform a dummy inference
